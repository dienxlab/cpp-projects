...
// configuration step. It creates a namespace called `cpp_projects`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_projects::cmake::project_name, cpp_projects::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_projects::cmake::project_version);
      return EXIT_SUCCESS;
    }
